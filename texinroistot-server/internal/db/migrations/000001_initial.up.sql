...
CREATE INDEX idx_villains_version ON public.villains USING btree (version);
CREATE INDEX idx_stories_version_hash ON public.stories USING btree (version, hash);
CREATE INDEX idx_villains_in_stories_villain ON public.villains_in_stories USING btree (villain);
CREATE INDEX idx_villains_in_stories_story ON public.villains_in_stories USING btree (story);
CREATE INDEX idx_stories_in_publications_story ON public.stories_in_publications USING btree (story);
CREATE INDEX idx_stories_in_publications_publication ON public.stories_in_publications USING btree (publication);
CREATE INDEX idx_publications_type ON public.publications USING btree (type);
CREATE INDEX idx_authors_in_stories_story ON public.authors_in_stories USING btree (story);
